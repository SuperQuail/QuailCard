import type { CardSource, ProviderSummary } from "../../domain/types";
...
export const mockProviders: MockProvider[] = [
  { id: "openai", name: "OpenAI", shortCode: "OA", protocol: "OpenAI Compatible", model: "gpt-4.1-mini", models: [{ id: "gpt-4.1-mini", name: "GPT-4.1 mini", contextWindow: 1048576, maxOutputTokens: 32768 }], baseUrl: "https://api.openai.com/v1", hasApiKey: true, hasCredential: true, authType: "api_key", oauthAccountId: null, providerType: "api", supportsVision: true, status: "connected" },
  { id: "anthropic", name: "Anthropic", shortCode: "AN", protocol: "Anthropic Messages", model: "claude-sonnet-4-5", models: [{ id: "claude-sonnet-4-5", name: "Claude Sonnet 4.5", contextWindow: 204800, maxOutputTokens: 16384 }], baseUrl: "https://api.anthropic.com", hasApiKey: false, hasCredential: false, authType: null, oauthAccountId: null, providerType: "api", supportsVision: true, status: "untested" },
  { id: "opencode_go", name: "OpenCode Go", shortCode: "OG", protocol: "OpenAI Compatible", model: "deepseek-v4-flash", models: [{ id: "deepseek-v4-flash", name: "DeepSeek V4 Flash", contextWindow: 1048576, maxOutputTokens: null }, { id: "deepseek-v4-pro", name: "DeepSeek V4 Pro", contextWindow: 1048576, maxOutputTokens: null }], baseUrl: "https://opencode.ai/zen/go/v1", hasApiKey: false, hasCredential: false, authType: null, oauthAccountId: null, providerType: "api", supportsVision: false, status: "untested" },
  { id: "openai_subscription", name: "OpenAI 订阅", shortCode: "OS", protocol: "OpenAI Compatible", model: "gpt-5.5", models: [{ id: "gpt-5.5", name: "GPT-5.5", contextWindow: null, maxOutputTokens: null }], baseUrl: "https://chatgpt.com/backend-api/codex/responses", hasApiKey: false, hasCredential: false, authType: null, oauthAccountId: null, providerType: "openai_subscription", supportsVision: true, status: "untested" },
];
