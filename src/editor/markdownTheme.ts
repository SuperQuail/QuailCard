...
const baseTheme = EditorView.theme({
  ...
  ".cm-scroller": {
    ...
    overflowY: "auto",
    // 原生条在 Windows 上带箭头：藏掉，位置交给 EditorPane 里与它同级的浮层滚动条。
    scrollbarWidth: "none",
...
const markdownHighlight = HighlightStyle.define([
  ...
  { tag: t.heading4, class: "qc-md-heading qc-md-heading-4" },
  { tag: t.heading5, class: "qc-md-heading qc-md-heading-5" },
  { tag: t.heading6, class: "qc-md-heading qc-md-heading-6" },
